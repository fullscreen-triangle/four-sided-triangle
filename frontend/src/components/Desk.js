...
import {useMemo, useContext, createContext, useRef, useEffect, Suspense} from 'react'
import { useGLTF, Merged, RenderTexture, PerspectiveCamera, Text,  BakeShadows, useVideoTexture, Environment } from '@react-three/drei'
 ...
 *
 * To use the video screens:
 * 1. Create a 'videos' folder in your public directory: mkdir -p public/videos
 * 2. Add MP4 video files to the videos folder
 * 3. Reference them in the ScreenVideo components using the path: "/videos/your-file-name.mp4"
 *
 * Video Requirements:
 * - Use MP4 format for best compatibility
 * - Optimal resolution: 1280x720 or 1920x1080 (landscape orientation)
 * - 30fps or 60fps recommended for smooth playback
 * - Keep file size reasonably small for better performance (2-10MB recommended)
 *
 * Wireframe Customization:
 * - Enable wireframe by setting wireframe={true} on any Screen component
 * - Customize wireframe color using wireframeColor="#hexcode"
 * - Add standalone wireframe meshes using the WireframeMesh component
 */
...
export function Computers(props) {
    ...
    return (
        <group {...props} dispose={null}  ref={groupRef}>
            ...
            <mesh geometry={n.Object_148.geometry} material={wireframeMaterial} position={[5.65, 2.79, 0.11]} rotation={[-Math.PI, 0, 0]} scale={-1} />
            ...
            <mesh  geometry={n.Object_160.geometry} material={wireframeMaterial} position={[5.06, 0, -1.6]} rotation={[-Math.PI, 0, 0]} scale={-1} />
            ...
            <mesh geometry={n.Object_176.geometry} material={wireframeMaterial} position={[1.33, 1.83, -3.82]} rotation={[-Math.PI, 0, 0]} scale={-1} />
            ...
            <mesh geometry={n.Object_180.geometry} material={wireframeMaterial} position={[4.86, 2.14, -2.54]} rotation={[-Math.PI, 0, 0]} scale={-1} />
            ...
            <mesh geometry={n.Object_184.geometry} material={wireframeMaterial} position={[5.06, 2.14, -1.6]} rotation={[-Math.PI, 0, 0]} scale={-1} />
            ...
            <mesh geometry={n.Object_188.geometry} material={wireframeMaterial} position={[2.59, 2.14, -4]} rotation={[-Math.PI, 0, 0]} scale={-1} />
            ...
            <mesh geometry={n.Object_192.geometry} material={wireframeMaterial} position={[1.66, 2.14, -4.54]} rotation={[-Math.PI, 0, 0]} scale={-1} />
            ...
            <mesh  geometry={n.Object_142.geometry} material={wireframeMaterial} position={[5.79, 0.94, 0.18]} rotation={[-Math.PI, 0, 0]} scale={-1} />
            ...
            <mesh  geometry={n.Object_146.geometry} material={wireframeMaterial} position={[5.43, 0.32, 0.37]} rotation={[-Math.PI, 0, 0]} scale={-1} />
            ...
            <mesh  geometry={n.Object_158.geometry} material={wireframeMaterial} position={[5.53, 0, -0.85]} rotation={[-Math.PI, 0, 0]} scale={-1} />
            ...
            <mesh  geometry={n.Object_182.geometry} material={wireframeMaterial} position={[5.53, 2.14, -0.85]} rotation={[-Math.PI, 0, 0]} scale={-1} />
            ...
            <ScreenVideo videoSrc="/videos/slow-motion-side-view.mp4"
                         frame="Object_206"
                         panel="Object_207"
                         position={[0.27, 1.53, -2.61]}
            />
            <ScreenVideo videoSrc="/videos/chigure-raw.mp4" frame="Object_209" panel="Object_210" y={5} position={[-1.43, 2.5, -1.8]} rotation={[0, 1, 0]} />
            <ScreenText invert frame="Object_212" panel="Object_213" x={-5} y={5} position={[-2.73, 0.63, -0.52]} rotation={[0, 1.09, 0]} />
            <ScreenVideo videoSrc="/videos/ben_johnson_seoul_final.mp4" frame="Object_215" panel="Object_216" position={[1.84, 0.38, -1.77]} rotation={[0, -Math.PI / 9, 0]} />

            {/* Video screens with wireframe option */}
            <ScreenVideo
                videoSrc="/videos/cheetah-wireframe.mp4"
                frame="Object_218"
                panel="Object_219"
            ...
            />
            <ScreenVideo
                videoSrc="/videos/1987WACMen_100m.mp4"
                frame="Object_221"
                panel="Object_222"
            ...
            {/* Remaining original screens */}
            <ScreenText invert frame="Object_224" panel="Object_225" position={[-3.9, 4.29, -2.64]} rotation={[0, 0.54, 0]} />
            <ScreenVideo videoSrc='/videos/smithsonian-cheetah-01.mp4' frame="Object_227" panel="Object_228" position={[0.96, 4.28, -4.2]} rotation={[0, -0.65, 0]} />
            <ScreenVideo videoSrc='/videos/evil_curve.mp4' frame="Object_230" panel="Object_231" position={[4.68, 4.29, -1.56]} rotation={[0, -Math.PI / 3, 0]} />
...
function ScreenVideo({ videoSrc, wireframe = false, wireframeColor = "#00ff00", ...props }) {
    // Configure the video texture with explicit options for looping and muting
...
/* A wireframe mesh that can be added to the scene */
...
// Create the main Desk component that wraps the Three.js scene
const Desk = () => {
    return (
