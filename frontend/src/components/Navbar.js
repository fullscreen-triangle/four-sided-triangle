...
import {
    FullscreenBitSparkIcon,GarminIcon,
    MoonIcon,
    PumaIcon,
    SunIcon,
    UnderArmourIcon,
    ...
    ">
            ...
            >
                <nav className="flex items-center justify-center">
                    <CustomLink className="mr-4" href="/" title="Home" toggle={handleClick} />
                    <CustomLink className="mx-4" href="/about" title="About" toggle={handleClick} />
                </nav>
                <nav
      ...
      "
                >
                    <motion.a
                        target={"_blank"}
                        className="w-2xs mr-3"
                        href="#"
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        aria-label="Garmin Forerunner, Pod"
                    >
                        <GarminIcon />
                    </motion.a>
                    <motion.a
                        target={"_blank"}
                        className="w-2xs mx-3"
                        href="#"
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        aria-label="Hver Series, Smoke Rideer, Heart Rate Monitor"
                    >
                        <UnderArmourIcon />
                    </motion.a>
                    <motion.a
                    ...
                    <motion.a
                        ...
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        aria-label="Fullscreen Triangle"
                    >
                        <FullscreenBitSparkIcon />
                    </motion.a>
